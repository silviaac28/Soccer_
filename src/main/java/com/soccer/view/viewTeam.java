...
public class viewTeam {
    ...
    public void start() {
        ...
        while (true) {
            ...
            System.out.println("7. Gestionar Doctores");
            System.out.println("8. Gestionar Entrenadores");
            ...
            switch (choice) {
                ...
                case 6: // Gestionar Jugadores
                    controlador.iniciarViewPlayer();
                    break;

                case 7: // Gestionar Doctores
                    controlador.iniciarViewDoctor();
                    break;

                case 8: // Gestionar Entrenadores
